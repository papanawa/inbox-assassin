...
export default function Settings() {
  ...
  return (
    <div className="max-w-2xl animate-slide-up">
      <div className="mb-8">
        <h2 className="font-display font-700 text-3xl text-ink-DEFAULT mb-1">Settings</h2>
      ...
      <section className="card mb-4">
        <div className="flex items-center gap-2 mb-4">
          ...
          <h3 className="font-display font-600 text-sm text-ink-DEFAULT">Account</h3>
        </div>
      ...
      <section className="card mb-4">
        <div className="flex items-center gap-2 mb-4">
          ...
          <h3 className="font-display font-600 text-sm text-ink-DEFAULT">Gmail Connection</h3>
        </div>
        <div className="flex items-center justify-between">
          <div>
            <div className="text-sm font-body text-ink-DEFAULT">Gmail API</div>
      ...
      <section className="card mb-4">
        <div className="flex items-center gap-2 mb-4">
          ...
          <h3 className="font-display font-600 text-sm text-ink-DEFAULT">Safety Settings</h3>
        </div>
      ...
      <section className="card border-assassin-red/20">
        ...
        <div className="flex items-center justify-between">
          <div>
            <div className="text-sm font-body text-ink-DEFAULT">Delete all my data</div>
...
function SettingRow({ label, value, mono }) {
  return (
    <div className="flex items-center justify-between py-1">
      ...
      <span className={`text-sm ${mono ? 'font-mono text-ink-muted text-xs' : 'font-body text-ink-DEFAULT'}`}>
        {value}
      </span>
    </div>
  )
...
function ToggleSetting({ label, description, defaultOn, locked }) {
  return (
    <div className="flex items-start justify-between gap-4">
      <div>
        <div className="text-sm font-body text-ink-DEFAULT">{label}</div>
      ...
      <div className={`w-9 h-5 rounded-full flex items-center shrink-0 mt-0.5 ${
        defaultOn ? 'bg-ink-DEFAULT' : 'bg-surface-border'
